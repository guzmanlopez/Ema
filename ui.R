...
shinyUI(pageWithSidebar(
  ...
  mainPanel(tabsetPanel(id="tabs",
                        ...
                        tabPanel("Acerca de esta APP",
                                 ...
                                 HTML('<div style="clear: left;"><img src="https://dl.dropboxusercontent.com/u/49775366/Ema/github-10-512.png" alt="" style="width: 5%; height: 5%; float: left; margin-right:5px" /></div>'),br(),
